...
namespace WpfApp1
{
    public class HttpRequester
    {
        ...
        public static string ExecuteIE(string URL, string METHOD = "POST", string Postdata = "", string Referer = "", string CharacterSet = "utf-8", string Content = "application/x-www-form-urlencoded", string Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8")
        {
            try
            {
                ...
                {
                    TextReader reader = new StreamReader(response.GetResponseStream(), Encoding.GetEncoding(CharacterSet));
